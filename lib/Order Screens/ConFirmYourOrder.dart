...
class ConfirmYourOrders extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConfirmYourOrders> createState() => _ConfirmYourOrdersState();
}

class _ConfirmYourOrdersState extends ConsumerState<ConfirmYourOrders> {
                ...
                child: Column(children: [
                  Expanded(
                    child: ListView.builder(
                        itemCount: widget.totalItems.length,
                        itemBuilder: ((context, index) {
                          final finalItems = widget.totalItems[index];
                            ...
                            children: [
                              Material(
                                ...
                                child: MaterialButton(
                                  ...
                                  height: 10.0,
                                  child:
                                      Text('CHECKOUT(${widget.totalItems.totalPrice})',
                                          style: TextStyle(
                                            color: Colors.white,
                                            fontSize: 16.0,
                                          )),
